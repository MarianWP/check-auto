...
const NewCheckView = () => import("./views/NewCheckView.vue");
...
const CheckView = () => import("./views/CheckView.vue");
const ReportView = () => import("./views/ReportView.vue");
const AdminView = () => import("./views/AdminView.vue");
const AdminItemsView = () => import("./views/AdminItemsView.vue");
const AdminItemView = () => import("./views/AdminItemView.vue");
const AdminPhotosView = () => import("./views/AdminPhotosView.vue");
